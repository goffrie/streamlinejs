/*** Generated by streamline 0.7.0 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch,__forIn=__rt.__forIn,__construct=__rt.__construct; var module = QUnit.module;
...
asyncTest("octal literal", 1, function __52(_) { var __frame = { name: "__52", line: 681 }; return __func(_, this, arguments, __52, 0, __frame, function __$__52() {
...
asyncTest("multiple-wrapped results", 1, function __55(_) { var __frame = { name: "__55", line: 708 }; return __func(_, this, arguments, __55, 0, __frame, function __$__55() {
    evalTest(function f(_) { var results;
      function wrapper(a, b, _) { var __frame = { name: "wrapper", line: 710 }; return __func(_, this, arguments, wrapper, 2, __frame, function __$wrapper() { return twoResults(a, b, __cb(_, __frame, 0, 37, _, true, true)); }); };
      function wrapper2(a, b, _) { var __frame = { name: "wrapper2", line: 711 }; return __func(_, this, arguments, wrapper2, 2, __frame, function __$wrapper2() { return wrapper(a, b)(__cb(_, __frame, 0, 38, _, true, true)); }); }; var __frame = { name: "f", line: 709 }; return __func(_, this, arguments, f, 0, __frame, function __$f() {
        return wrapper2("abc", "def")(__cb(_, __frame, 3, 16, function ___(__0, __1) { results = __1;
          return _(null, JSON.stringify(results)); }, true, true)); });
    }, "[[[\"abc\",\"def\"]]]"); _(); });});