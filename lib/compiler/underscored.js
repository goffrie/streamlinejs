...
function errorHandler() {
	function mungeStackFrame(frame) {
		...
		var source = map && map.originalPositionFor({line: line, column: column});
		...
		frame.getFileName = function() { return fileName; };
		frame.getLineNumber = function() { return line; };
		frame.getColumnNumber = function() { return column; };
	};
